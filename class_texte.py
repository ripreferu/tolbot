...
ajout=["être","avoir","bien","ce","cela","celui","cet","cette","ex","à","au","en","est","il","jamais","qu'","quel","comment","puis","si","la","une","en","donc","dire","de", "ø","ceci","c\'","pourtant","cependant","car"]
...
class Texte():
    ...
    def __one_hot__(self):
        assert (len(self.__voc__)>0),"Vocabulary error: please use the vocabulary()"
